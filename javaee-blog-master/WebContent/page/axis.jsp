...
<body  background="/Blog/img/backgroundimg/time.jpg">
	...
	<div class="container" id="main">
		...
		<div class="row c_center">
			...
			<br>
				<div id="list">
					<table class="table table-hover c_center">
						<tr>
							<td><a href="/Blog/logServlet?get=all"><span class="glyphicon glyphicon-home"></span>
								&nbsp;&nbsp;日志首页</a></td>
						</tr>
						<tr>	
			...
			<div class="col-md-9 " id="axis_div" >
				<!-- 这里初始化时间轴 -->		
