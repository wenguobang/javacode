...
<body >
	...
	<div class="container" id="main">		
		<div id="title">
			...
			<td></td>
			<td><h4><a href="/Blog/logServlet?get=all">日志首页</a></h4></td>
			</tr>
			</table>
		</div>						
		   <form action="/Blog/NewArticleServlet" method="post">
		   		...
		   		<input type="text" class="form-control" name="author" value="文国邦">	
		   		<!-- sort --> 				
		...
		<div id="footer">
		<h3 style="color:Green"><a href="#"><b><i>W.<span style="color:Black">Blog</span></i></b></a></h3>
